            ...
            <div className={darkMode ? claro.bgColor : escuro.bgColor}>
                ...
                <div className="flex md:mx-15">
                    <div className="flex md:h-66">
                        <i className={darkMode ? claro.iconbooks : escuro.iconbooks} data-aos="zoom-in" data-aos-easing="linear" data-aos-duration="100" data-aos-anchor-placement="top-center">📚</i>
                ...
                <div className="flex md:mx-15 ">
                    <div className="flex md:h-66">
                        <i className={darkMode ? claro.iconbooks : escuro.iconbooks} data-aos="zoom-in" data-aos-easing="linear" data-aos-duration="200" data-aos-anchor-placement="top-center">📚</i>
                        <div className={darkMode ? claro.linha : escuro.linha}>
                            <span className={darkMode ? claro.spantext : escuro.spantext}>2025 - Cursando </span>
                ...
                <div className="flex md:mx-15">
                    <div className="flex md:h-66">
                        <i className={darkMode ? claro.iconbooks : escuro.iconbooks} data-aos="zoom-in" data-aos-easing="linear" data-aos-duration="300" data-aos-anchor-placement="top-center">📚</i>
                        <div className={darkMode ? claro.linha : escuro.linha}>
                            <span className={darkMode ? claro.spantext : escuro.spantext}>2025 - Cursando </span>
                            <h3 className={darkMode ? claro.cursoTxt : escuro.cursoTxt}>
                ...
                <div className="flex md:mx-15">
                    <div className="flex md:h-66">
                        <i className={darkMode ? claro.iconbooks : escuro.iconbooks} data-aos="zoom-in" data-aos-easing="linear" data-aos-duration="400" data-aos-anchor-placement="top-center">📚</i>
                        <div className={darkMode ? claro.linha : escuro.linha}>
                ...
                <div className="flex md:mx-15">
                    <div className="flex md:h-52">
                        <i className={darkMode ? claro.iconbooks : escuro.iconbooks} data-aos="zoom-in" data-aos-easing="linear" data-aos-duration="500" data-aos-anchor-placement="top-center">📚</i>
                        <div className={darkMode ? claro.linha : escuro.linha}>
                ...
                <div className="flex md:mx-15">
                    <div className="flex md:h-52">
                        <i className={darkMode ? claro.iconbooks : escuro.iconbooks} data-aos="zoom-in" data-aos-easing="linear" data-aos-duration="600" data-aos-anchor-placement="top-center">📚</i>
                        <div className={darkMode ? claro.linha : escuro.linha}>
                            <span className={darkMode ? claro.spantext : escuro.spantext}>2024 - 2024</span>
                ...
                <div className="flex md:mx-15">
                    <div className="flex ">
                        <i className={darkMode ? claro.iconbooks : escuro.iconbooks} data-aos="zoom-in" data-aos-easing="linear" data-aos-duration="700" data-aos-anchor-placement="top-center">📚</i>
                    </div>
                </div>
                <IoIosAdd
                    className={darkMode ? claro.xizinho : escuro.xizinho}
