...
const Estudo: React.FC = () => {
    ...
    const claro: Tema = {
        ...
        xizinho: "text-6xl text-[#7f5af0] transition duration-400 ease-in-out"
    }
    const escuro: Tema = {
        ...
        xizinho: "text-6xl text-[#0400ff] transition duration-400 ease-in-out"  
    }
            ...
            <div className={darkMode ? claro.bgColor : escuro.bgColor}>
                ...
                <div className="flex mx-15">
                    <div className="flex h-65">
                        ...
                        <IoIosAdd className={darkMode ? claro.xizinho : escuro.xizinho  } />
                    </div>
                </div>
                <div className="flex mx-15">
